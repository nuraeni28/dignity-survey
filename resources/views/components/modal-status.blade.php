<div class="modal fade" id="N{{ $volunteer->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('relawan.getstatus', ['userId' => $volunteer->id, 'page' => $volunteers->currentPage()]) }}" method="POST">
                @csrf
...
<div class="modal fade" id="All" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            @endphp
            <form action="{{ route('relawan.getStatusKabupaten') }}" method="POST">
                @csrf
                <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                    {{-- <input type="hidden" id="id" name="id"> --}}
                    <div class="row">
