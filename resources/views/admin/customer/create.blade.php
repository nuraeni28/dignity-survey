...
@section('title', 'Buat Responden')

@section('content_header')
    <h1>Buat Responden</h1>
@stop
...
.required-asterisk {
    ...
    font-weight: bold; /* Optionally make the asterisk bold */
}
   ...
   <x-adminlte-input value="{{ old('name') }}" name="name" required label="Nama " placeholder="nama"
    ...
    <x-slot name="prependSlot">
      ...
      <x-slot name="label">
        ...
        <x-adminlte-input value="{{ old('email') }}" name="email" label="Email (Tidak Wajib)" placeholder="email" type="email"
            igroup-size="md">
            <x-slot name="prependSlot">
                <div class="input-group-text bg-dark">
        ...
        <x-adminlte-input value="{{ old('phone') }}" name="phone" label="Phone (Tidak Wajib)" placeholder="phone" type="number"
            igroup-size="md" />
        <x-adminlte-input value="{{ old('dob') }}" name="dob" label="Tanggal Lahir (Tidak Wajib)" placeholder="tanggal lahir"
            type="date" igroup-size="md" />
        ...
        @elseif (Gate::check('koordinator-area'))
            ...
            <x-adminlte-select id="district" name="indonesia_district_id">
                ...
                @endforeach
                <x-slot name="label">
        <label for="name" class="required-label">Kecamatan <span class="required-asterisk">(Wajib)</span></label>
    </x-slot>
            </x-adminlte-select>
            <x-adminlte-select name="indonesia_village_id" id="village">
                ...
                @endforeach
                <x-slot name="label">
        <label for="name" class="required-label">Desa <span class="required-asterisk">(Wajib)</span></label>
    </x-slot>
            </x-adminlte-select>
        @else
        ...
        <x-adminlte-input value="{{ old('family_member') }}" name="family_member" label="Jumlah Anggota Keluarga (Tidak Wajib)"
            placeholder="jumlah anggota keluarga" type="number" igroup-size="md" />
        <x-adminlte-input value="{{ old('family_election') }}" name="family_election" label="Jumlah Pemilih Dalam KK (Tidak Wajib)"
            placeholder="jumlah pemilih dalam kk" type="number" igroup-size="md" />
        ...
        <x-adminlte-input value="{{ old('tps') }}" name="tps" label="TPS (Tidak Wajib)" placeholder="TPS" type="number"
            igroup-size="md" />
