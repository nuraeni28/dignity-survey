...
<form action="{{route('question.store')}}" method="post">
  @csrf
  <x-adminlte-input name="question" value="{{old('question')}}" required label="Pertanyaan" placeholder="pertanyaan" type="text" igroup-size="md" />
  ...
  <div id="option_field" class="py-2" style="display: none">
    ...
    <x-adminlte-button id="option_button" type="button" label="Tambah Opsi" theme="success" icon="fas fa-lg fa-plus" />
  </div>
