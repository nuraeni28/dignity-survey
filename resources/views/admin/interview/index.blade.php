...
@section('title', 'Interviews Relawan Lapangan')
    ...
    <div class="col">
        <div style="display: flex; align-items: center;">
            <div class="d-flex justify-content-between"
                ...
                <form action="{{ route('interview.index') }}" method="GET" class="form-inline d-flex">
        ...
        <div class="col" style="margin-top:20px">
            <form action="{{ route('interview.index') }}" method="GET">
                    ...
                    <div class="ms-2 d-inline-block">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <br>
                                <img src="{{ asset('assets/filter.png') }}" alt="Logo" class="logo"
