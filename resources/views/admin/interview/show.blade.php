...
@section('title', 'Detail Interview Relawan Lapangan')
        ...
        <div class="card-body p-0">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="50%">
                        <a
                            href="{{ route('responden.show', $schedule->respondent->id) }}">{{ $schedule->respondent->name }}</a>
                    </td>
                </tr>
                <tr>
                        ...
                        <tbody>
                            @foreach ($schedule->interview->data as $data)
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->respondent_answer)
                                            {{ $data->respondent_answer }}
                                        @else
                                            {{ __('-') }}
                                        @endif
                                    </td>
